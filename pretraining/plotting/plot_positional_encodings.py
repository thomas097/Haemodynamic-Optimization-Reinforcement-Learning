...
def visualize_rel_positions(pos_encoders, n_blocks, n_heads, max_dist=72, steps=1000):
    ...
    rel_pos = torch.linspace(0, max_dist, steps).unsqueeze(0).unsqueeze(0).unsqueeze(0)
...
if __name__ == '__main__':
    ...
    visualize_rel_positions(pos_encoders, n_blocks=3, n_heads=4, max_dist=12, steps=1000)