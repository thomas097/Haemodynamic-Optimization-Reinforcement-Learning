-- This query pivots the vital signs for whole admission of a patient's stay
...
FROM  (
  ...
  , case
    ...
    when itemid in (807,811,1529,3745,3744,225664,220621,226537) and valuenum > 0 then 8 -- Glucose
      ...
      -- convert F to C
  , case when itemid in (223761,678) then (valuenum-32)/1.8 else valuenum end as valuenum -- to celsius
